...
import {
  ...
  Schemas$InvoiceItemUpdateBody,
} from "@sideko-inc/stripe/types/invoice-item-update-body";
...
export type UpdateRequest = {
  data?: InvoiceItemUpdateBody | undefined;
  invoiceitem: string;
};
...
export type External$UpdateRequest = {
  data?: External$InvoiceItemUpdateBody | undefined;
  invoiceitem: string;
};
...
> = z
  .object({
    data: Schemas$InvoiceItemUpdateBody.in.optional(),
    invoiceitem: z.string(),
  })
  .transform((obj) => {
    return zodTransform(obj, {
...
> = z
  .object({
    data: Schemas$InvoiceItemUpdateBody.out.optional(),
    invoiceitem: z.string(),
  })
  .transform((obj) => {
    return zodTransform(obj, {
