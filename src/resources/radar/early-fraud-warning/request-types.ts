...
import {
  External$RadarEarlyFraudWarningListCreatedObj0,
  RadarEarlyFraudWarningListCreatedObj0,
  Schemas$RadarEarlyFraudWarningListCreatedObj0,
} from "@sideko-inc/stripe/types/radar-early-fraud-warning-list-created-obj0";
...
export type ListRequest = {
   ...
   */
  created?: (RadarEarlyFraudWarningListCreatedObj0 | number) | undefined;
  /**
...
export type External$ListRequest = {
  charge?: string | undefined;
  created?:
    | (External$RadarEarlyFraudWarningListCreatedObj0 | number)
    | undefined;
...
> = z
  .object({
    ...
    created: z
      .union([
        Schemas$RadarEarlyFraudWarningListCreatedObj0.in,
        z.number().int(),
      ])
      .optional(),
