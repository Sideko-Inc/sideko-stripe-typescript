...
import {
  External$LinkedAccountDisconnectBody,
  LinkedAccountDisconnectBody,
  Schemas$LinkedAccountDisconnectBody,
} from "@sideko-inc/stripe/types/linked-account-disconnect-body";
import {
  External$LinkedAccountListAccountHolder,
  LinkedAccountListAccountHolder,
  Schemas$LinkedAccountListAccountHolder,
} from "@sideko-inc/stripe/types/linked-account-list-account-holder";
...
export type ListRequest = {
   ...
   */
  accountHolder?: LinkedAccountListAccountHolder | undefined;
  /**
...
export type External$ListRequest = {
  account_holder?: External$LinkedAccountListAccountHolder | undefined;
...
> = z
  .object({
    account_holder: Schemas$LinkedAccountListAccountHolder.in.optional(),
...
> = z
  .object({
    accountHolder: Schemas$LinkedAccountListAccountHolder.out.optional(),
...
export type DisconnectRequest = {
  data?: LinkedAccountDisconnectBody | undefined;
  account: string;
};
...
export type External$DisconnectRequest = {
  data?: External$LinkedAccountDisconnectBody | undefined;
  account: string;
};
...
> = z
  .object({
    data: Schemas$LinkedAccountDisconnectBody.in.optional(),
    account: z.string(),
  })
  .transform((obj) => {
    return zodTransform(obj, {
...
> = z
  .object({
    data: Schemas$LinkedAccountDisconnectBody.out.optional(),
    account: z.string(),
  })
  .transform((obj) => {
    return zodTransform(obj, {
