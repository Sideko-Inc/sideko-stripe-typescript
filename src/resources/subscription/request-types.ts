...
} from "@sideko-inc/stripe/types/subscription-create-body-add-invoice-items-item";
import {
  External$SubscriptionCreateBodyAutomaticTax,
  Schemas$SubscriptionCreateBodyAutomaticTax,
  SubscriptionCreateBodyAutomaticTax,
} from "@sideko-inc/stripe/types/subscription-create-body-automatic-tax";
import {
...
} from "@sideko-inc/stripe/types/subscription-create-body-billing-cycle-anchor-config";
import {
...
} from "@sideko-inc/stripe/types/subscription-create-body-discounts-arr0-item";
import {
...
} from "@sideko-inc/stripe/types/subscription-create-body-payment-settings";
import {
...
} from "@sideko-inc/stripe/types/subscription-create-body-pending-invoice-item-interval-obj0";
import {
  External$SubscriptionCreateBodyTransferData,
  Schemas$SubscriptionCreateBodyTransferData,
  SubscriptionCreateBodyTransferData,
} from "@sideko-inc/stripe/types/subscription-create-body-transfer-data";
import {
...
} from "@sideko-inc/stripe/types/subscription-create-body-trial-settings";
import {
  External$SubscriptionDeleteBody,
  Schemas$SubscriptionDeleteBody,
  SubscriptionDeleteBody,
} from "@sideko-inc/stripe/types/subscription-delete-body";
import {
  External$SubscriptionListAutomaticTax,
  Schemas$SubscriptionListAutomaticTax,
  SubscriptionListAutomaticTax,
} from "@sideko-inc/stripe/types/subscription-list-automatic-tax";
import {
  External$SubscriptionListCreatedObj0,
  Schemas$SubscriptionListCreatedObj0,
  SubscriptionListCreatedObj0,
} from "@sideko-inc/stripe/types/subscription-list-created-obj0";
import {
  External$SubscriptionListCurrentPeriodEndObj0,
  Schemas$SubscriptionListCurrentPeriodEndObj0,
  SubscriptionListCurrentPeriodEndObj0,
} from "@sideko-inc/stripe/types/subscription-list-current-period-end-obj0";
import {
  External$SubscriptionListCurrentPeriodStartObj0,
  Schemas$SubscriptionListCurrentPeriodStartObj0,
  SubscriptionListCurrentPeriodStartObj0,
} from "@sideko-inc/stripe/types/subscription-list-current-period-start-obj0";
import {
  External$SubscriptionResumeBody,
  Schemas$SubscriptionResumeBody,
  SubscriptionResumeBody,
} from "@sideko-inc/stripe/types/subscription-resume-body";
import {
  External$SubscriptionUpdateBody,
  Schemas$SubscriptionUpdateBody,
  SubscriptionUpdateBody,
} from "@sideko-inc/stripe/types/subscription-update-body";
...
export type DeleteRequest = {
  data?: SubscriptionDeleteBody | undefined;
...
export type External$DeleteRequest = {
  data?: External$SubscriptionDeleteBody | undefined;
...
> = z
  .object({
    data: Schemas$SubscriptionDeleteBody.in.optional(),
...
> = z
  .object({
    data: Schemas$SubscriptionDeleteBody.out.optional(),
...
export type ListRequest = {
   ...
   */
  automaticTax?: SubscriptionListAutomaticTax | undefined;
  /**
   ...
   */
  created?: (SubscriptionListCreatedObj0 | number) | undefined;
  /**
   * Only return subscriptions whose current_period_end falls within the given date interval.
   */
  currentPeriodEnd?:
    | (SubscriptionListCurrentPeriodEndObj0 | number)
    | undefined;
  /**
   * Only return subscriptions whose current_period_start falls within the given date interval.
   */
  currentPeriodStart?:
    | (SubscriptionListCurrentPeriodStartObj0 | number)
    | undefined;
  /**
...
export type External$ListRequest = {
  automatic_tax?: External$SubscriptionListAutomaticTax | undefined;
  collection_method?: ("charge_automatically" | "send_invoice") | undefined;
  created?: (External$SubscriptionListCreatedObj0 | number) | undefined;
  current_period_end?:
    | (External$SubscriptionListCurrentPeriodEndObj0 | number)
    | undefined;
  current_period_start?:
    | (External$SubscriptionListCurrentPeriodStartObj0 | number)
    | undefined;
  customer?: string | undefined;
...
> = z
  .object({
    automatic_tax: Schemas$SubscriptionListAutomaticTax.in.optional(),
    collection_method: z
      .enum(["charge_automatically", "send_invoice"])
      .optional(),
    created: z
      .union([Schemas$SubscriptionListCreatedObj0.in, z.number().int()])
      .optional(),
    current_period_end: z
      .union([
        Schemas$SubscriptionListCurrentPeriodEndObj0.in,
        z.number().int(),
      ])
      .optional(),
    current_period_start: z
      .union([
        Schemas$SubscriptionListCurrentPeriodStartObj0.in,
        z.number().int(),
      ])
      .optional(),
...
> = z
  .object({
    automaticTax: Schemas$SubscriptionListAutomaticTax.out.optional(),
    collectionMethod: z
      .enum(["charge_automatically", "send_invoice"])
      .optional(),
    created: z
...
export type UpdateRequest = {
  data?: SubscriptionUpdateBody | undefined;
  subscriptionExposedId: string;
};
...
export type External$UpdateRequest = {
  data?: External$SubscriptionUpdateBody | undefined;
  subscription_exposed_id: string;
};
...
> = z
  .object({
    data: Schemas$SubscriptionUpdateBody.in.optional(),
    subscription_exposed_id: z.string(),
  })
  .transform((obj) => {
    return zodTransform(obj, {
...
> = z
  .object({
    data: Schemas$SubscriptionUpdateBody.out.optional(),
    subscriptionExposedId: z.string(),
  })
  .transform((obj) => {
    return zodTransform(obj, {
...
export type ResumeRequest = {
  data?: SubscriptionResumeBody | undefined;
  subscription: string;
};

/**
 * @internal
 * ResumeRequest without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$ResumeRequest = {
  data?: External$SubscriptionResumeBody | undefined;
  subscription: string;
};

/**
 * Takes network data, validates it, and transforms keys to match typescript object ResumeRequest
 */
const SchemaIn$ResumeRequest: z.ZodType<
  ResumeRequest, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
    data: Schemas$SubscriptionResumeBody.in.optional(),
...
/**
 * @internal
 * Takes typescript data, validates it, and maps keys to match the expected external object External$ResumeRequest
 */
const SchemaOut$ResumeRequest: z.ZodType<
  External$ResumeRequest, // output type of this zod object
  z.ZodTypeDef,
  ResumeRequest // the object to be transformed
> = z
  .object({
    data: Schemas$SubscriptionResumeBody.out.optional(),
    subscription: z.string(),
  })
  .transform((obj) => {
    return zodTransform(obj, {
...
export const Schemas$ResumeRequest = {
  in: SchemaIn$ResumeRequest,
  out: SchemaOut$ResumeRequest,
};
